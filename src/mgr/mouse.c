...
void ms_init(int screen_w, int screen_h, char *mouse_type)
{
  ...
  if (mouse_type) {
    if (strcasecmp(mouse_type, "microsoft") == 0)
      mtype = 0;
    else if (strcasecmp(mouse_type, "mousesystems3") == 0)
      mtype = 1;
    else if (strcasecmp(mouse_type, "mousesystems5") == 0)
      mtype = 2;
    else if (strcasecmp(mouse_type, "mmseries") == 0)
      mtype = 3;
    else if (strcasecmp(mouse_type, "logitech") == 0)
      mtype = 4;
    else if (strcasecmp(mouse_type, "ps2") == 0)
      mtype = 5;
    else if (strcasecmp(mouse_type, "busmouse") == 0)
      mtype = 6;
  }
